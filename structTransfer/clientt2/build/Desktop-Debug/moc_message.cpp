...
static constexpr auto qt_meta_stringdata_ZN7messageE = QtMocHelpers::stringData(
    "message"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7messageE[] = {
...
Q_CONSTINIT const QMetaObject message::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7messageE.offsetsAndSizes,
    qt_meta_data_ZN7messageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7messageE_t,
        // Q_OBJECT / Q_GADGET
...
void *message::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7messageE.stringdata0))
